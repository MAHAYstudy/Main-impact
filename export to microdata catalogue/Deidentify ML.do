...
* Purpose: Deidentifing ML data to be publicly available
...
global original "${Mada}/midline/Data/data - original/export to microdata catalogue/Original/"
global deidentified "${Mada}/midline/Data/data - original/export to microdata catalogue/De-identified/"
...
copy "${original}cb03acalendrierdesactivitsdusit.dta" "${deidentified}acn_calendrier.dta" , replace
...
copy "${original}men_liquide.dta" "${deidentified}men_liquide.dta" , replace
copy "${original}men_emploi_du_temps.dta" "${deidentified}men_emploi_du_temps.dta" , replace
...
drop _merge 
label drop a02 a03 a04 a05
order idmen idind idmere id a01 a02 a03 a04 a05 a06
